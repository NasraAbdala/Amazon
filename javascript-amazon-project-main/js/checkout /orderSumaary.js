...
import { cart, removeProducid, updateDeliveryOption } from '../../data/cart.js';
import { formatCurrency } from '../utils/money.js';
//import {updateCartQuantity} from './amazonJs.js';
import { hello } from 'https://unpkg.com/supersimpledev@1.0.1/hello.esm.js';
import dayjs from 'https://unpkg.com/dayjs@1.11.10/esm/index.js';
import { deliveryOptions,getDlivery } from '../../data/deliveryOptions.js';
...
export function RenderOrderSummary() {
  ...
  //matchingProduct = products.find((product) => product.id === productId);
   ...
   // };
    ...
    const deliveroption = getDlivery(deliverOpoid);
    const today = dayjs();
  ...
  function deliveryOpti(matchingProduct, item) {
   ...
   js-delivery-Options" data-product-id="${matchingProduct.id}" data-delivery-option-id="${delivery.id}">
                  <input type="radio"
                  ${isChecked ?'checked':''}
